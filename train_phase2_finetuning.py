#!/usr/bin/env python
# train_phase2_finetuning.py — Phase 2: Agent Finetuning (BC + reward model).
#
...
@hydra.main(config_path="configs", config_name="train_phase2_finetuning", version_base=None)
